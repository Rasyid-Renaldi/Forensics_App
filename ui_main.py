...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.detectDevice.setItemText(0, QCoreApplication.translate(
            "MainWindow", u"SerialNumber", None))

        self.resultCek.setText(QCoreApplication.translate(
            "MainWindow", u"Result :", None))
        self.Int.setText(QCoreApplication.translate(
            "MainWindow", u"Int :", None))
        self.Ext.setText(QCoreApplication.translate(
            "MainWindow", u"Ext :", None))
        self.result.setText(QCoreApplication.translate(
            "MainWindow", u"Not Root!", None))
